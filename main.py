...
from services.ai_service import understand_problem, analyze_system_data
...
while True:
    ...
    if isinstance(analysis, ProblemAnalysis):
        ...
        analysis_result = analyze_system_data(analysis.problem, analysis.investigation, system_data)
